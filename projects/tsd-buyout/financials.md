...
| Item | Value | Notes |
|------|-------|-------|
| Transaction type | Equity buyout | Rick buys Polly's 50% stake |
| Purchase price | TBD | See valuation section below |
| Payment structure | Negotiating | Polly wants all cash; Rick prefers partial seller financing |
| Target close date | July 31 or Aug 31, 2026 | To be decided |
...
|--------|-------------|--------------------------|
| Book value | Assets minus liabilities | Likely the floor — anchors on $2M cash |
| Revenue | ~1x for companies under $10M | Need TSD revenue figure to calculate |
...
- What is the tax liability from the sale of the other two divisions (ERP business)?
- What is the company's current general tax liability?
- How does the buyout structure affect Rick's personal tax position?

## Price vs. terms

Per CPA advisor: there is significant leeway in price versus terms. Key lever:
- Polly wants all cash → Rick can offer a **higher price in exchange for seller financing**
- Or push for **lower price for all cash** if Polly won't budge on financing
- Use GBQ for a conservative independent valuation to anchor the price conversation

## Advisors identified

| Name | Firm | Role | When to engage |
|------|------|------|----------------|
| GBQ | GBQ Partners | Valuator (conservative) | Now — if neutral valuation route chosen |
| Tom Pampush | Ice Miller | M&A Attorney | When term sheet is ready |
| (Rick's CPA friend) | TBD | Advisor / sounding board | Ongoing |

## Deal cost budget (placeholder)

| Item | Estimated cost |
|------|---------------|
| Valuation (GBQ, split?) | ~$2,000–$5,000 |
| M&A attorney (Ice Miller) | TBD |
| CPA / tax advice | TBD |
| Transition / backfill costs | TBD |
| **Total** | |
