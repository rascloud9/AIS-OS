...
CONTROLS = [
    ...
    (1,"Control Environment","1.2","Full staff list (name, hire date, term date — all during review period)","provide","in-progress","Amy","",""),
    (1,"Control Environment","1.3","Background checks — sample employees","remote","remote","","","Pulled from 1.2 sample"),
    (1,"Control Environment","1.4","Contract employees (1099) hired since June 1 2025 — names and hire dates","provide","in-progress","Amy","",""),
    ...
    (1,"Control Environment","1.7","2 written job descriptions","provide","missing","","",""),
    (1,"Control Environment","1.8","Candidate evaluation process","tbd","tbd","","","Confirm with Audit Manager"),
    (1,"Control Environment","1.9","2 job descriptions noting duties to interact/monitor third-party vendors","provide","missing","","","Can overlap with 1.7"),
    ...
    (1,"Control Environment","1.13","Board of directors oversight","tbd","tbd","","","Confirm with Audit Manager"),
    (1,"Control Environment","1.14","BOD meeting dates since June 1 2025","provide","missing","","",""),
    (1,"Control Environment","1.15","InfoSec importance communicated to employees","tbd","tbd","","","Confirm with Audit Manager"),
    (1,"Control Environment","1.16","Corporate mission statement","provide","collected","","Deliverables\\Employee-Handbookv4.pdf","Our Mission & Values section"),
    (1,"Control Environment","1.17","Trade shows attended, publications used, or industry association memberships","provide","missing","","",""),
    (1,"Control Environment","1.18","Management meeting schedule/cadence","tbd","tbd","","","Confirm with Audit Manager"),
    (1,"Control Environment","1.19","Updated organizational chart","provide","collected","","Deliverables\\RG_Org_Chart_2026_05_12.pdf",""),
    ...
    (1,"Control Environment","1.22","Annual performance review listing (employee name, supervisor, review date since June 1 2025)","provide","missing","","",""),
    ...
    (2,"Physical Security","2.6","Most recent SOC 1 Type 2 or SOC 2 Type 2 report from data center (Azure)","provide","collected","","Deliverables\\Microsoft 365 Central Services - SOC 2 Type 2 Report (9-30-2025).pdf + bridge letters","Satisfies 2.6, 2.7, 3.2, 5.7, 5.13, 8.9"),
    ...
    (5,"System Uptime","5.1","Annual risk assessment documentation","provide","missing","","","Template provided by auditor"),
    ...
    (5,"System Uptime","5.5","Closed infrastructure change tickets since June 1 2025 (Excel/CSV: ticket #, open date, close date, requestor, performer)","provide","missing","","","From HaloPSA"),
    (5,"System Uptime","5.6","Tickets/change forms list (same format as 5.5)","provide","missing","","","From HaloPSA"),
    ...
    (5,"System Uptime","5.10","SLA / policies / RTO / RPO documentation on acceptable downtime levels","provide","missing","","",""),
    (5,"System Uptime","5.11","Enterprise monitoring app screenshot — alert thresholds/configs","provide","missing","","",""),
    (5,"System Uptime","5.12","Enterprise monitoring app screenshot — alert thresholds/configs","provide","missing","","","Same as 5.11"),
    ...
    (5,"System Uptime","5.16","Current agreements with critical third-party vendors","provide","missing","","",""),
    ...
    (5,"System Uptime","5.19","Antivirus app screenshot — configs/settings","provide","missing","","",""),
    ...
    (5,"System Uptime","5.23","List of all workstations and laptops (names)","provide","missing","","",""),

    # Matrix 6 — Information Security
    (6,"Information Security","6.1","Documented information security policies and procedures","provide","collected","","Deliverables\\6.1 Security-Policy.docx",""),
    ...
    (6,"Information Security","6.3","Updated network diagram","provide","missing","","",""),
    (6,"Information Security","6.4","Security monitoring — remote review","remote","remote","","",""),
    (6,"Information Security","6.5","Most recent vulnerability assessment tool (VAT) test report","provide","missing","","",""),
    ...
    (6,"Information Security","6.9","Dates of documented user access reviews since June 1 2025 (quarterly)","provide","missing","","",""),
    (6,"Information Security","6.10","Dates of documented admin access reviews since June 1 2025 (quarterly)","provide","missing","","",""),
    (6,"Information Security","6.11","Software install restrictions","remote","remote","","",""),
    (6,"Information Security","6.12","Names and titles of staff with admin rights: Network / AD / DB / Applications","provide","missing","","",""),
    ...
    (6,"Information Security","6.19","List of vendors with access to sensitive data onboarded since June 1 2025 (names + NDAs)","provide","missing","","",""),
    (6,"Information Security","6.20","Vendor system review","remote","remote","","Deliverables\\Halo Services Solutions Ltd. - 2025 SOC 2 Type 2 Report.pdf + Intuit QuickBooks Online Ecosystem SOC 2 Type II (09-01-2024 to 04-30-2025).pdf + bridge letter","HaloPSA + QuickBooks SOC 2 reports on hand"),
    (6,"Information Security","6.21","User authentication (unique ID + password)","remote","remote","","",""),
    (6,"Information Security","6.22","Internal domain password config screenshot (complexity, length, expiry)","provide","missing","","",""),
    (6,"Information Security","6.23","Account lockout config screenshot","provide","missing","","",""),
    ...
    (6,"Information Security","6.30","Names and titles of staff with specific production access","provide","missing","","",""),
    ...
    (8,"Application Development","8.1","Documented coding standards","provide","missing","","","May be N/A — confirm if RG does custom dev"),
    ...
    (8,"Application Development","8.5","Names and titles with version control access","provide","missing","","",""),
    (8,"Application Development","8.6","Change management tickets (Excel/CSV: ticket #, open, close, requestor, performer, QA, approver)","provide","missing","","","From HaloPSA or dev system"),
    (8,"Application Development","8.7","Tickets/change forms list (same format as 8.6)","provide","missing","","",""),
    (8,"Application Development","8.8","Versioning history since June 1 2025","provide","missing","","",""),
    (8,"Application Development","8.9","Data center SOC report","provide","collected","","Same as 2.6",""),
    (8,"Application Development","8.10","Management memo reviewing SOC report","provide","collected","","Same as 2.8",""),
    (8,"Application Development","8.11","QA testing","remote","remote","","",""),
    (8,"Application Development","8.12","Names and titles with QA environment access","provide","missing","","",""),
...
def build_tracker():
    ...
    sub_cell = ws.cell(row=2, column=1,
        value="Review period: June 1, 2025 – May 31, 2026  |  Information requests due: June 16, 2026  |  50 documents to provide")
